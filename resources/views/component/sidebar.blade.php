<ul class="d-lg-block order-md-0 d-flex d-flex order-1 nav position-fixed" id="side_button_ul">
  <li class="mt-0 mt-lg-5"><a href="{{url('/')}}" class="nav-link text-dark h5 side_button col"><i class="fas fa-home fa-fw fa-1x"></i><span>ホーム</span></a></li>
  <li class="mt-0 mt-lg-5"><a href="{{url('/profile')}}" class="nav-link text-dark h5 side_button col"><i class="fas fa-user-circle fa-fw fa-1x"></i><span>マイページ</span></a></li>
  <li type="button" data-toggle="modal" data-target="#myModal" class="nav-link h5 bg-base mt-0 mt-lg-5 side_button col pl-0 pr-0 btn btn-primary"><i class="fas fa-pen fa-fw fa-1x"></i><span>投稿</span></a></li>
</ul>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <ul id="myTab" class="nav nav-tabs md-tabs tabs-2 light-blue darken-3" role="tablist">
          ...
          <li class="nav-item">
            <a href="#music" id="music-tab" class="nav-link active col" role="tab" data-toggle="tab" aria-controls="home" aria-selected="true">作曲</a>
          </li>

          <li class="nav-item">
            <a href="#profile" id="profile-tab" class="nav-link col" role="tab" data-toggle="tab" aria-controls="profile" aria-selected="false">歌詞</a>
          </li>
